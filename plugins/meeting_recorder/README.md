...
Requer Nexus Core `1.1.0-beta.4` ou superior. Versões anteriores não possuem o
...
bot. Somente ID, nome, username e URL verificada — nunca o token — são mantidos
como metadados no banco.
