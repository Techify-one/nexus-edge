...
const ptBR = {
  ...
  "dashboard.installedPlugins": "Plugins instalados",
  "dashboard.installedPluginsDescription":
    "Abra os recursos adicionados ao seu ambiente.",
  "dashboard.searchPlugins": "Buscar plugins",
  "dashboard.openPlugin": "Abrir plugin",
  "dashboard.pluginWithoutPage": "Plugin sem página disponível",
  "dashboard.noPluginResults": "Nenhum plugin corresponde à busca.",
  "dashboard.noInstalledPlugins": "Nenhum plugin disponível para você.",
...
const en: Record<TranslationKey, string> = {
  ...
  "dashboard.installedPluginsDescription":
    "Open the features added to your environment.",
  "dashboard.searchPlugins": "Search plugins",
  "dashboard.openPlugin": "Open plugin",
  "dashboard.pluginWithoutPage": "Plugin without an available page",
  "dashboard.noPluginResults": "No plugins match your search.",
  "dashboard.noInstalledPlugins": "No plugins are available to you.",
