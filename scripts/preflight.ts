...
const requiredFiles = [
  ...
  "workers/core/migrations/d1/0009_plugin_marketplaces.sql",
  ...
  "workers/core/migrations/postgres/0007_core_updates.sql",
  "workers/core/migrations/postgres/0008_plugin_runtime_resources.sql",
  "workers/core/migrations/postgres/0009_plugin_marketplaces.sql",
  "plugins/template/manifest.json",
  "plugins/template/migrations/d1/0001_init.sql",
  "plugins/template/migrations/postgres/0001_init.sql",
  "frontend/src/main.tsx",
  "frontend/src/plugins/PluginPageHost.tsx",
  "packages/plugin-sdk/src/index.ts",
  "packages/plugin-sdk/src/table.ts",
  "plugins/template/frontend/entry.ts",
